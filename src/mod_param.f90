...
! define parameters
       ...
       REAL(SP), PARAMETER:: RHO_W = 1026.0_SP
!       REAL(SP), PARAMETER:: RHO_AW = 0.0012041_SP
       REAL(SP), PARAMETER:: DEG2RAD = 0.0175_SP
       REAL(SP), PARAMETER:: YEAR2SEC = 31104000.0_SP
       REAL(SP), PARAMETER:: YEAR2DAY = 360.0_SP
       REAL(SP), PARAMETER:: DAY2SEC  = 86400.0_SP
       REAL(SP), PARAMETER:: rho_sed = 2650.0_SP
