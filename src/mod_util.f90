...
! Fengyan Shi to facilitate input in the TVD solver.  
!=======================================================================
...
contains
  ...
  !---------------------------------------------------------------------
  Subroutine Get_Integer_Val(ival,filename,argname,line,ierr,echo,start,finish)  
  implicit none
...
!     write(*,*) trim(argname),'is not specified.' 
  ...
  !---------------------------------------------------------------------
  Subroutine Get_Float_Val(fval,filename,argname,line,ierr,echo,start,finish)  
  implicit none
...
!              'does not exist in file: '//trim(filename)) 
  ...
  !---------------------------------------------------------------------
  Subroutine Get_Logical_Val(lval,filename,argname,line,ierr,echo,start,finish)  
  implicit none
